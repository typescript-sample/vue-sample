        ...
        <div class='row'>
            <section class='col s12 m12 l6'>
                ...
                <label class='switch-container'>
                    <input type='checkbox' id='searchEnginesLinksToMyProfile' name='searchEnginesLinksToMyProfile'
                        v-model='settings.searchEnginesLinksToMyProfile' />
                    {{resource.user_settings_search_engines_links_to_my_profile}}
                </label>
                <label class='switch-container'>
                    <input type='checkbox' id='followingListPublicOnMyProfile' name='followingListPublicOnMyProfile'
            ...
            <section class='col s12 m12 l6'>
                ...
                <label class='switch-container'>
                    <input type='checkbox' id='showMyProfileInSpacesAroundMe' name='showMyProfileInSpacesAroundMe'
                        v-model='settings.showMyProfileInSpacesAroundMe' />
                    {{resource.user_settings_show_my_profile_in_spaces_around_me}}
                </label>
                <label class='switch-container'>
                    <input type='checkbox' id='showAroundMeResultsInMemberFeed' name='showAroundMeResultsInMemberFeed'
            ...
            <section class='col s12 m12 l6'>
                ...
                <label class='switch-container'>
                    <input type='checkbox' id='notification' name='notification' v-model='settings.notification' />
                ...
                <div className='checkbox-section'>
                    ...
                    <div className='checkbox-group'>
                        <label>
                            <input type='checkbox' id='notifyFeedUpdates' name='notifyFeedUpdates'
                                v-model='settings.notifyFeedUpdates' />
                            {{resource.notification}}
                        </label>
                        <label>
                            <input type='checkbox' id='emailFeedUpdates' name='emailFeedUpdates'
                ...
                <div className='checkbox-section'>
                    ...
                    <div className='checkbox-group'>
                        <label>
                            <input type='checkbox' id='notifyPostMentions' name='notifyPostMentions'
                                v-model='settings.notifyPostMentions' />
                            {{resource.notification}}
                        </label>
                        <label>
                            <input type='checkbox' id='emailPostMentions' name='emailPostMentions'
                ...
                <div className='checkbox-section'>
                    ...
                    <div className='checkbox-group'>
                        <label>
                            <input type='checkbox' id='notifyCommentsOfYourPosts' name='notifyCommentsOfYourPosts'
                                v-model='settings.notifyCommentsOfYourPosts' />
                            {{resource.notification}}
                        </label>
                        <label>
                            <input type='checkbox' id='emailCommentsOfYourPosts' name='emailCommentsOfYourPosts'
                ...
                <div className='checkbox-section'>
                    ...
                    <div className='checkbox-group'>
                        <label>
                            <input type='checkbox' id='notifyEventInvitations' name='notifyEventInvitations'
                                v-model='settings.notifyEventInvitations' />
                            {{resource.notification}}
                        </label>
                        <label>
                            <input type='checkbox' id='emailEventInvitations' name='emailEventInvitations'
                ...
                <div className='checkbox-section'>
                    ...
                    <div className='checkbox-group'>
                        <label>
                            <input type='checkbox' id='notifyWhenNewEventsAround' name='notifyWhenNewEventsAround'
                                v-model='settings.notifyWhenNewEventsAround' />
                            {{resource.notification}}
                        </label>
                        <label>
                            <input type='checkbox' id='emailWhenNewEventsAround' name='emailWhenNewEventsAround'
...
<script lang="ts">
import { getResource, handleError, message, StringMap } from "uione";
import { Options, Vue } from "vue-class-component";
import { MyProfileService, useMyProfileService, UserSettings } from "./my-profile";
