      ...
      <div class="row">
        <div class="col m12 l4">
          ...
          <div class="card" v-if="user.skills && user.skills.length > 0">
            ...
            <section>
              <p v-for="(item, index) in user.skills" :key="index">
                {{ item.skill
                }}<i :hidden="!item.hirable" class="star highlight" />
              </p>
              <hr />
              <p class="description">
          ...
          <div
            class="card"
            v-if="user.lookingFor && user.lookingFor.length > 0"
          >
            <header>
            ...
            <section>
              <p v-for="(item, index) in user.lookingFor" :key="index">
                {{ item }}
              </p>
            </section>
          </div>
        ...
        <div class="col m12 l8">
          <div
            class="card border-bottom-highlight"
            v-if="user.bio && user.bio.length > 0"
          >
            <header>
