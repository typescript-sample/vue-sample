<template>
  <div class="view-container">
    ...
    <div>
      <form id="itemsForm" name="itemsForm" :novalidate="true">
...
export default class ItemsComponent extends SearchComponent<Item, ItemFilter> {
  status = [];
  viewable = true;
  editable = true;
  hideFilter = true;
  ...
  created() {
    ...
    this.onCreated(itemService, inputSearch());
  }
  mounted() {
  ...
  edit(id: string) {
    navigate(this.$router, "/admin/items", [id]);
  }
